          ...
          <div class="form__top">
            ...
            <div class="price form__price">
              ...
              <div class="price__part price__new text-accent">
                <span class="x_price_current"> <?= $cms->price; ?> </span><span class="x_currency"> <?= $cms->currency; ?>
                </span>
              </div>
            </div>
          </div>
  ...
  <section class="doc bg block animate-block" style="margin-bottom: 21px">
    <div class="doc__content">
      <div class="doc__item doc__item--1">
        <div class="doc__wrap">
          <p class="doc__text">
            Soy el Dr. Carlos Ménde, y como especialista en salud, recomiendo
          ...
          <h3 class="doc__name">Dr. Carlos Ménde</h3>
          <p class="doc__pos">
    ...
    <div class="container">
      ...
      <ul class="reviews__list reviews-list">
        <li class="reviews-list__item">
          ...
          <h2 class="reviews-list__name">Alejandro Morales</h2>
        ...
        <li class="reviews-list__item">
          ...
          <h2 class="reviews-list__name">José Castillo</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          ...
          <h2 class="reviews-list__name">Ricardo López</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          ...
          <h2 class="reviews-list__name">María Rodríguez</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          ...
          <h2 class="reviews-list__name">Ana Martínez</h2>
          <p class="reviews-list__city"></p>
        ...
        <li class="reviews-list__item">
          ...
          <h2 class="reviews-list__name">Carmen Jiménez</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate reviews-list__rate--4"></span>
          <div>
        ...
        <li class="reviews-list__item">
          ...
          <h2 class="reviews-list__name">Daniel Herrera</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          ...
          <h2 class="reviews-list__name">Miguel González</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          ...
          <h2 class="reviews-list__name">Juan Pérez</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          <picture>
            <source type="image/webp" srcset="images/m5.webp" />
            <img class="reviews-list__img" src="images/m5.webp" alt="" width="87" height="87" />
          </picture>
          <h2 class="reviews-list__name">Esteban Ramírez</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          <picture>
            <source type="image/webp" srcset="images/m6.webp" />
            <img class="reviews-list__img" src="images/m6.webp" alt="" width="87" height="87" />
          </picture>
          <h2 class="reviews-list__name">Fernando Reyes</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          <picture>
            <source type="image/webp" srcset="images/m7.webp" />
            <img class="reviews-list__img" src="images/m7.webp" alt="" width="87" height="87" />
          </picture>
          <h2 class="reviews-list__name">Antonio Sánchez</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          <picture>
            <source type="image/webp" srcset="images/m8.webp" />
            <img class="reviews-list__img" src="images/m8.webp" alt="" width="87" height="87" />
          </picture>
          <h2 class="reviews-list__name">Luis Aguilar</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          <picture>
            <source type="image/webp" srcset="images/w6.webp" />
            <img class="reviews-list__img" src="images/w6.webp" alt="" width="87" height="87" />
          </picture>
          <h2 class="reviews-list__name">Sofía Chávez</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          <picture>
            <source type="image/webp" srcset="images/w7.webp" />
            <img class="reviews-list__img" src="images/w7.webp" alt="" width="87" height="87" />
          </picture>
          <h2 class="reviews-list__name">Isabel Gutiérrez</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <li class="reviews-list__item">
          <picture>
            <source type="image/webp" srcset="images/w8.webp" />
            <img class="reviews-list__img" src="images/w8.webp" alt="" width="87" height="87" />
          </picture>
          <h2 class="reviews-list__name">Teresa Romero</h2>
          <p class="reviews-list__city"></p>
          <span class="reviews-list__rate"></span>
          <div>
        ...
        <div class="helps__block">
          <div class="action__pack">
            <picture class="action__prod">
              <source type="image/webp" srcset="images/prod1-2.webp" />
              <img class="action__img" src="images/prod1-2.webp" alt="" width="600" />
            </picture>
          </div>
        </div>
        <p class="helps__text">
              ...
              <div class="form__content">
                <div class="form__top">
                  ...
                  <div class="price form__price form__price--border">
                    ...
                    <span class="price__div"></span>
                    <div class="price__part price__new text-accent">
                      <span class="x_price_current"> <?= $cms->price; ?> </span>
                      <span class="x_currency"> <?= $cms->currency; ?> </span>
                    </div>
                  </div>
                </div>
